    ...
    return await prisma.$transaction(async (tx) => {
      ...
      const invoice = await tx.invoice.create({
        data: {
          ...
          remi_five_charges: remi_five_charges ? String(remi_five_charges) : null,
          reward_penalty_input: reward_penalty_input || '0',
          reward_penalty_amount: toDecimal(reward_penalty_amount),
          note: note || null,
          po_no: po_no || null,
          irn_no: irn_no || null,
          status: 'Open',
